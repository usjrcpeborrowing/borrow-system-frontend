...
@NgModule({
  declarations: [DashboardButtonsComponent,SnackbarComponent, NotificationComponent, BorrowItemCategoryComponent, EquipmentDetailDialogComponent, DashboardButtonsComponent],
  ...
  exports: [DashboardButtonsComponent, SnackbarComponent, NotificationComponent, BorrowItemCategoryComponent, EquipmentDetailDialogComponent],
})
